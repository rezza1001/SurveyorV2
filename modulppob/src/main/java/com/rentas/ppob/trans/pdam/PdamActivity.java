package com.rentas.ppob.trans.pdam;
...
public class PdamActivity extends MyActivity {
    ...
    protected int setLayout() {
        return R.layout.multifinance_activity_main;
    }
        ...
        post.setOnReceiveListener((obj, code, message) -> {
            if (code == ErrorCode.OK){
                try {
                    ...
                    e.printStackTrace();
                    Utility.showFailedDialog(mActivity, e.getMessage());
                }
            }
            else {
