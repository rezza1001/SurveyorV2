...
public class ReceiptFailedActivity extends MyActivity {

    private HeaderView header_view;
    private LinearLayout lnly_body;
    private TextView txvw_nameHeader,txvw_note;
    private StringBuilder copyAsText = new StringBuilder();

    @Override
    protected int setLayout() {
        return R.layout.report_receipt_activity_failed;
    }
    ...
    protected void initLayout() {
        ...
        header_view.create("Transaksi Gagal");
...
//                    addItem("Diskon","Rp 0", true);
    ...
    private void buildItem(JSONArray ja ) throws JSONException {
        for (int i=0; i<ja.length(); i++){
            ...
            if (label.equalsIgnoreCase("keterangan")){
                txvw_note.setText(value);
                continue;
            }
