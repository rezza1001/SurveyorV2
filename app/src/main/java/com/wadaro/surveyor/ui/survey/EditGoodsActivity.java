...
public class EditGoodsActivity extends MyActivity {
    ...
    private void save() {
        ...
        PostManager post = new PostManager(mActivity, "process-survey/update-product");
        post.addParam(new ObjectApi("sales_detail_id", getIntent().getStringExtra("SALES_DETAIL_ID")));
